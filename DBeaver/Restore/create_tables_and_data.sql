...
insert into Persons values (1, 'Professor', 'Matocha', 'Jeff', 'matochaj@obu.edu', 'Unique_Key_1', 0, 'Yes');

insert into Persons values (2, 'Senior', 'Short', 'Thomas', 'sho74451@obu.edu', 'Unique_Key_2', 1, 'No');

insert into Persons values (3, 'Senior', 'Terry', 'Micah', 'ter74542@obu.edu', 'Unique_Key_3', 1, 'No');

insert into Persons values (4, 'Senior', 'Garcia', 'Kristopher', 'gar76751@obu.edu', 'Unique_Key_4', 1, 'No');

insert into Persons values (5, 'Senior', 'Spraggins', 'Samuel', 'spr75664@obu.edu', 'Unique_Key_5', 1, 'No');

insert into Persons values (6, 'Senior', 'Bostian', 'Corbin', 'bos67070@obu.edu', 'Unique_Key_6', 1, 'No');

insert into Persons values (7, 'Junior', 'Marine', 'Olivia', 'mar77947@obu.edu', 'Unique_Key_7', 1, 'No');

insert into Persons values (8, 'Freshman', 'Esho', 'Samuel', 'esh82048@obu.edu', 'Unique_Key_8', 10, 'No');

insert into Persons values (9, 'Sophomore', 'Ernest', 'Noah', 'ern79879@obu.edu', 'Unique_Key_9', 1, 'No');

insert into Persons values (10, 'Professor', 'Sykes', 'Jeff', 'sykesj@obu.edu', 'ABC123', 0, 'Yes);
